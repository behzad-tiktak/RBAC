...
namespace RBACSystem.BusinessLogic.RBAC
{
    ...
    public class PermissionManager
    {
        ...
        #region متد Update Role برای RoleManager

        /// <summary>
        /// ویرایش نقش - باید به RoleManager اضافه شود
        /// این متد موقتاً اینجا است
        /// </summary>
        public bool UpdateRole(Role role, int modifiedBy)
        {
            try
            {
                ...
                Role existingRole = roleRepo.GetRoleById(role.RoleId);
                ...
                bool updated = roleRepo.UpdateRole(role);
        ...
        public int CreatePermission(Permission permission, int createdBy)
        {
            try
            {
                ...
                int newPermissionId = _permissionRepo.InsertPermission(permission);
        ...
        public bool UpdatePermission(Permission permission, int modifiedBy)
        {
            try
            {
                ...
                // ذخیره (این متد باید در Repository اضافه شود)
                bool updated = _permissionRepo.UpdatePermission(permission);
        ...
        public bool DeletePermission(int permissionId, int deletedBy)
        {
            try
            {
                ...
                bool deleted = DeletePermission(permissionId, deletedBy);
